 ...
 * @file csyrk_batch.c
 *
 * @brief BBLAS csyrk_batch  for float _Complex routine.
 *
...
/**
 * Code generation
 * @generated from ../src/zsyrk_batch.c normal z -> c, Mon Jun  6 09:44:14 2016
 **/
#endif
...
/**
    Purpose
    -------
    <b>csyrk_batch</b> is a batch version of csyrk.
