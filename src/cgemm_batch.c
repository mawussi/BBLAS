 ...
 * @file cgemm_batch.c
 *
 *  @brief BBLAS cgemm_batch float _Complex routine.
 *
...
/**
 * Code generation
 * @generated from ../src/zgemm_batch.c normal z -> c, Mon Jun  6 09:44:13 2016
 **/
#endif
...
/**
    Purpose
    -------
    <b>cgemm_batch</b> is a batch version of cgemm.
    ...
    }else if (batch_opts ==  BBLAS_VARIABLE)
    {
        for (batch_iter = 0; batch_iter < batch_count; batch_iter++)
        {
            ...
            if (M[batch_iter] == 0 || N[batch_iter] == 0 ||
                ((alpha[batch_iter] == (BBLAS_Complex32_t)0.0 || K[batch_iter] == 0) &&
