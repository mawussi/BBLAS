 ...
 * @file ssyrk_batch.c
 *
 * @brief BBLAS ssyrk_batch  for float routine.
 *
...
/**
 * Code generation
 * @generated from ../src/zsyrk_batch.c normal z -> s, Mon Jun  6 09:44:13 2016
 **/
#endif
...
/**
    Purpose
    -------
    <b>ssyrk_batch</b> is a batch version of ssyrk.
