subs = {
  ...
  'mixed' : [
    ...
    ('BBLAS_Complex64_t','double'),
    ('BBLAS_Complex32_t','float'),
    ...
    ('zhegv','dsygv'),
    ('zhegst','dsygst'),
    ('BBLAS_Alloc_Workspace_zgels','BBLAS_Alloc_Workspace_dgels'),
    ('bblas_pc',    'bblas_ps'),
    ('bblas_pz',    'bblas_pd'),
    ('BBLAS_z',     'BBLAS_d'),
    ('BBLAS_c',     'BBLAS_s'),
    ('bblas_coop',  'bblas_soop'),
    ('bblas_zoop',  'bblas_doop'),
    ('bblas_cip',   'bblas_sip'),
    ('bblas_zip',   'bblas_dip'),
    ('bblas_cdesc', 'bblas_sdesc'),
    ('bblas_zdesc', 'bblas_ddesc'),
    ('unmqr','ormqr'),
    ('unmlq','ormlq'),
    ('he2hb','sy2sb'),
    ('hb2st','sy2st'),
  ...
  'normal' : [ ## Dictionary is keyed on substitution type
    ...
    ('float',          'double',          'BBLAS_voidComplex32_t','BBLAS_voidComplex64_t'),
