...
subs = {
  ...
  'mixed' : [
    ...
    # ----- BBLAS / MAGMA functions, alphabetic order
    ('dsaxpy',                    'zcaxpy'                  ),
    ('dslaswp',                   'zclaswp'                 ),
  ...
  'normal' : [
    ...
    ('float',                'double',               'void',   'BBLAS_MKL_Void_t'  ),
    ...
    ('morse_s',        'morse_d',        'morse_c',        'morse_z'         ),
    ('bblas_ps',      'bblas_pd',      'bblas_pc',      'bblas_pz'       ),
    ('BBLAS_S',       'BBLAS_D',       'BBLAS_C',       'BBLAS_Z'        ),
    ('BBLAS_sor',     'BBLAS_dor',     'BBLAS_cun',     'BBLAS_zun'      ),
    ('BBLAS_s',       'BBLAS_d',       'BBLAS_c',       'BBLAS_z'        ),
    ('bblas_s',       'bblas_d',       'bblas_c',       'bblas_z'        ),
    ('parse_s',       'parse_d',       'parse_c',       'parse_z'        ),
