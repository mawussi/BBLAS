...
/**
 * Code generation
 * @generated from bblas_zparsefile.c normal z -> c, Mon Jun  6 09:44:13 2016
 **/
#endif
...
void bblas_checkconfig(bblas_ctest_t *test);

/**
 * parse_cconfigfile reads the parameter file
...
{
    /*Local variables */
    char *filename="bblas_cparsefile.c";
