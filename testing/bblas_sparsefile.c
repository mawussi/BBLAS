...
/**
 * Code generation
 * @generated from bblas_zparsefile.c normal z -> s, Mon Jun  6 09:44:14 2016
 **/
#endif
...
void bblas_checkconfig(bblas_stest_t *test);

/**
 * parse_sconfigfile reads the parameter file
...
{
    /*Local variables */
    char *filename="bblas_sparsefile.c";
