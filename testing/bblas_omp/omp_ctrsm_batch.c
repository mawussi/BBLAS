/**
 * @file omp_ctrsm_batch.c
 *
 * @brief BBLAS omp_ctrsm_batch float _Complex routine.
 *
...
/**
 * Code generation
 * @generated from ./bblas_omp/omp_ztrsm_batch.c normal z -> c, Mon Jun  6 09:44:14 2016
 **/
#endif
...
/**
    Purpose
    -------
    <b>ctrsm_batch</b> is an OpenMP version of ctrsm_batch.
    ...
    info   Array of <tt>int</tt>.
	       Each element info[i] is the error return code of the ith ctrsm in the batch,
