/**
 * @file omp_dtrmm_batch.c
 *
 * @brief BBLAS omp_dtrmm_batch double routine.
...
/**
 * Code generation
 * @generated from ./bblas_omp/omp_ztrmm_batch.c normal z -> d, Mon Jun  6 09:44:14 2016
 **/
#endif
...
/**
    Purpose
    -------
    <b>dtrmm_batch</b> is an OpenMP version of dtrmm_batch.
    ...
    info   Array of <tt>int</tt>.
	       Each element info[i] is the error return code of the ith dtrmm in the batch,
