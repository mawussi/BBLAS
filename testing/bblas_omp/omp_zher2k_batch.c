...
/**
    Purpose
    -------
    <b>zher2k_batch</b> is an OpenMP version of zherk2_batch.
    ...
    info   Array of <tt>int</tt>.
	       Each element info[i] is the error return code of the ith zher2k in the batch,
...
/*Local variables  */
    ...
    int batch_iter;
    int LDA,  LDB;
    char func_name[15] = "zher2k_batch";
	...
	/* particular case */
	if (N[first_index] == 0 ||
	    ((K[first_index] == 0 || alpha[first_index] == (BBLAS_Complex64_t)0.0) &&
