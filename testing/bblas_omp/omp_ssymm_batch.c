/**
 * @file omp_ssymm_batch.c
 *
 * @brief BBLAS omp_ssymm_batch float routine.
 *
...
/**
 * Code generation
 * @generated from ./bblas_omp/omp_zsymm_batch.c normal z -> s, Mon Jun  6 09:44:14 2016
 **/
#endif
...
/**
    Purpose
    -------
    <b>ssymm_batch</b> is an OpenMP version of ssymm_batch.
