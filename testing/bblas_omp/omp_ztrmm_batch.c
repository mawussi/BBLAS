...
/**
    Purpose
    -------
    <b>ztrmm_batch</b> is an OpenMP version of ztrmm_batch.
    ...
    info   Array of <tt>int</tt>.
	       Each element info[i] is the error return code of the ith ztrmm in the batch,
