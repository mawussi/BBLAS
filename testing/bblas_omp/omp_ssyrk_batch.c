/**
 * @file omp_ssyrk_batch.c
 *
 * @brief BBLAS omp_ssyrk_batch float routine.
 *
...
/**
 * Code generation
 * @generated from ./bblas_omp/omp_zsyrk_batch.c normal z -> s, Mon Jun  6 09:44:14 2016
 **/
#endif
...
/**
    Purpose
    -------
    <b>ssyrk_batch</b> is an OpenMP version of ssyrk_batch.
    ...
    info   Array of <tt>int</tt>.
	       Each element info[i] is the error return code of the ith ssyrk in the batch,
