/**
 * @file omp_zhemm_batch.c
 *
 * @brief BBLAS omp_zhemm_batch double _Complex routine.
 *
...
/**
    Purpose
    -------
    <b>zhemm_batch</b> is an OpenMP version of zhemm_batch.
    ...
    info   Array of <tt>int</tt>.
	        Each element info[i] is the error return code of the ith zhemm in the batch,
