/**
 * @file omp_dsyrk_batch.c
 *
 * @brief BBLAS omp_dsyrk_batch double routine.
 *
...
/**
 * Code generation
 * @generated from ./bblas_omp/omp_zsyrk_batch.c normal z -> d, Mon Jun  6 09:44:13 2016
 **/
#endif
...
/**
    Purpose
    -------
    <b>dsyrk_batch</b> is an OpenMP version of dsyrk_batch.
    ...
    info   Array of <tt>int</tt>.
	       Each element info[i] is the error return code of the ith dsyrk in the batch,
