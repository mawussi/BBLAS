/**
 * @file omp_csyrk_batch.c
 *
 * @brief BBLAS omp_csyrk_batch float _Complex routine.
 *
...
/**
 * Code generation
 * @generated from ./bblas_omp/omp_zsyrk_batch.c normal z -> c, Mon Jun  6 09:44:14 2016
 **/
#endif
...
/**
    Purpose
    -------
    <b>csyrk_batch</b> is an OpenMP version of csyrk_batch.
    ...
    info   Array of <tt>int</tt>.
	       Each element info[i] is the error return code of the ith csyrk in the batch,
