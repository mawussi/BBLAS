/**
 * @file omp_dtrsm_batch.c
 *
 * @brief BBLAS omp_dtrsm_batch double routine.
 *
...
/**
 * Code generation
 * @generated from ./bblas_omp/omp_ztrsm_batch.c normal z -> d, Mon Jun  6 09:44:13 2016
 **/
#endif
...
/**
    Purpose
    -------
    <b>dtrsm_batch</b> is an OpenMP version of dtrsm_batch.
    ...
    @param[in]
    alpha   Array of DOUBLE PRECISION
    ...
    info   Array of <tt>int</tt>.
	       Each element info[i] is the error return code of the ith dtrsm in the batch,
