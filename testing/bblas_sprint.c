 ...
 * @file bblas_sprint.c
 *
 * @brief BBLAS printing routines for float routines.
 *
...
/**
 * Code generation
 * @generated from bblas_zprint.c normal z -> s, Mon Jun  6 09:44:13 2016
 **/
#endif
...
void bblas_sprint_result(bblas_stest_t *test)
{
	...
	case BBLAS_MKL:
	    ...
	    bblas_spassed_failed(test, test->mkl_max_error, test_passed_failed, error_in_info);
    ...
    case BBLAS_MAGMA:
	    ...
	    bblas_spassed_failed(test, test->device_max_error, test_passed_failed, error_in_info);
	...
	case BBLAS_OTHER:
	    ...
	    bblas_spassed_failed(test, test->other_max_error, test_passed_failed, error_in_info);
	...
	case BBLAS_CUMKL:
	    ...
	    break;
	default:
	    printf("In bblas_sprint_result(): Target not defined\n");
	    exit(EXIT_FAILURE);
    }
}
...
void bblas_sprint_parameters(bblas_stest_t *test)
{
    ...
    char funcname[] = "bblas_sprint_parameters";
    char separator[] = "--";
    char  col[]="|";
    int first_index =0;
	char* transA;
